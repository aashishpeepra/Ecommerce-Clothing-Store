...
const SingleProduct = React.lazy(() =>
  import("./Containers/Single-Product/SingleProduct")
);
const Products = React.lazy(() => import("./Containers/Products/Products"));
const LogIn = React.lazy(() => import("./Containers/LogIn/LogIn"));
const Signup = React.lazy(() => import("./Containers/Signup/Signup"));
const LoginSignup = React.lazy(() =>
  import("./Containers/LoginSignup/LoginSignup")
);
...
const AdminOrders = React.lazy(() =>
  import("./Containers/Admin/AdminOrders/AdminOrders")
);
const AdminProducts = React.lazy(() =>
  import("./Containers/Admin/AdminProducts/AdminProducts")
);

const EachOrder = React.lazy(() =>
  import("./Containers/UserDetails/EachOrder/EachOrder")
);
  ...
  render() {
    return (
      <Suspense fallback={<h1 style={{ marginTop: "80px" }}>Loading...</h1>}>
        <Switch>
          <Route path="/admin/orders/:id" component={EachOrder} />
