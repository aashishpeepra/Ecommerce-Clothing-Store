...
class Checkout extends React.Component {
  ...
  submitOrder = () => {
    ...
    let previousOrders;
    if (userBasic.orders == undefined) previousOrders = [];
    else previousOrders = [...userBasic.orders];
    let sum = 0;
    for (let i = 0; i < cartData.length; i++)
      sum += cartData[i].data.price * cartData[i].qty;
    ...
    let image =
      totalOrders.length == 0
        ? cartData[0].data.images[0]
        : totalOrders[0].items[0].data.images[0];
    let currentOrder = {
          ...
          <div>
            ...
            <form>
              <fieldset>
                ...
                <input
                  onChange={this.onChanger1}
                  value={this.state.userInfo.location.city}
                  type="text"
                  name="city"
                  id="city"
                  placeholder="City"
              ...
              <fieldset>
                ...
                <input
                  onChange={this.onChanger1}
                  value={this.state.userInfo.location.address}
                  type="text"
                  name="address"
                  id="address"
                  placeholder="Address"
              ...
              <fieldset>
                ...
                <input
                  onChange={this.onChanger1}
                  value={this.state.userInfo.location.pincode}
                  type="number"
                  name="pincode"
                  id="pin"
                  placeholder="Pincode"
